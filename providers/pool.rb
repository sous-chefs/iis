...
action :config do
	...
	Chef::Log.debug(cmd)
	shell_out!(cmd)
	if @new_resource.private_mem != nil
	...
	if @new_resource.recycle_at_time != nil
	...
	if @new_resource.runtime_version != nil
