...
def configure
  ...
  if cmd_current_values.stderr.empty?
    ...
    should_clear_apppool_schedules = ((new_resource.recycle_at_time && is_new_recycle_at_time) || node_array.length > 1) || (new_resource.recycle_schedule_clear && node_array.length > 1)
