...
action :config do
  ...
  if cmd_current_values.stderr.empty?
    ...
    is_new_log_directory = is_new_value?(doc.root,"SITE/logFiles/@directory",@new_resource.log_directory.to_s)
    is_new_log_period = is_new_value?(doc.root, "SITE/logFile/@period", @new_resource.log_period.to_s)
    is_new_log_trunc = is_new_value?(doc.root, "SITE/logFiles/@truncateSize",@new_resource.log_truncsize.to_s)
